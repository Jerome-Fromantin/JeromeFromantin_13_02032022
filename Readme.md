...
Dernière mise à jour : 21-03-2022 08h45
...
- Ajout de messages d'erreur pour le formulaire de connexion.

Travail à faire :
- Création d'un fichier YAML selon Swagger indiquant les endpoints supplémentaires de l'API.
- Et d'autres choses ?