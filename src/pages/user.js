    ...
    return (
        <HelmetProvider>
            ...
            <main className="main bg-dark">
                ...
                linkPath="/transactions/:id/:checking" transButton="View transactions"/>
                <Account title="Argent Bank Savings (x6712)" amount="$10,928.42" amountDescr="Available Balance"
                linkPath="/transactions/:id/:savings" transButton="View transactions"/>
                <Account title="Argent Bank Credit Card (x8349)" amount="$184.30" amountDescr="Current Balance"
                linkPath="/transactions/:id/:creditCard" transButton="View transactions"/>
            </main>
        </HelmetProvider>
    )
}
